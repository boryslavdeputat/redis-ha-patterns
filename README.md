...
High-availability patterns for **Redis** and **Amazon ElastiCache**: replication, cluster mode, failover, cache stampede, key design.

## Contents

- `docs/TOPOLOGIES.md` - standalone, replica, cluster mode
- `docs/FAILOVER.md`
- `docs/CACHE_STAMPEDE.md`
- `docs/KEY_DESIGN.md`
- `scripts/redis_health.py`
- `examples/elasticache-parameter-notes.md`
